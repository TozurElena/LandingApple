...
// возвращает только слово, склонение слова
...
const timer = deadline => {
    ...
    const unitDescriptionDay = document.querySelector('.timer__unit-description_day');
    const unitDescriptionHour = document.querySelector('.timer__unit-description_hour');
    const unitDescriptionMin = document.querySelector('.timer__unit-description_min');

    const getTimeRemaning = () => {
        const dateStop = new Date(deadline).getTime(); // in ms
        const dateNow = Date.now(); // in ms
